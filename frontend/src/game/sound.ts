...
export const playClickSound = () => {
  try {
    ...
    noiseGain.gain.linearRampToValueAtTime(1.5, time + 0.01); 
    ...
    thudGain.gain.linearRampToValueAtTime(2.0, time + 0.01);
